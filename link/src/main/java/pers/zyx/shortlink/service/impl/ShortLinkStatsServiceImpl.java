...
public class ShortLinkStatsServiceImpl implements ShortLinkStatsService {
    ...
    public ShortLinkStatsRespDTO oneShortLinkStats(ShortLinkStatsReqDTO requestParam) {
        ...
        for(int i = 1; i <= 7; i++) {
            ...
            int weekdayCount = listWeekdayStatsByShortLink.stream()
        ...
        List<LinkDeviceStatsDO> listDeviceStatsByShortLink = linkDeviceStatsMapper.listDevicesStatsByShortLink(requestParam);
